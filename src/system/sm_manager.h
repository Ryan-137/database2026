...
class SmManager {
   ...
   public:
    ...
    // Bulk-load a CSV file whose first row contains the table column names.
    // The path is interpreted relative to the opened database directory.
    void load_data(const std::string& file_name, const std::string& tab_name);
